        ...
        .then(data => {
            ...
            if (!responseOk) {
                ...
                if(Local.reservas.length > 0){
                    let marketing = Local.reservas.length + 10;
                    html.push(`<div class="mt-5 m-lg-5 d-flex justify-content-between align-items-center">
                        <div class="alert alert-dark alert-dismissible fade show" role="alert">
                        Ya han reservado `+marketing+` ususarios, date prisa que las plazas vuelan.
